          ...
          <Link href="/admin/documents" className="block">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-blue-600">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Documents Manager</h3>
                  <p className="text-gray-600 text-sm mt-1">Create and manage AI knowledge documents</p>
                </div>
              </div>
            </div>
          </Link>
